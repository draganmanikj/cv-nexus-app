...
const DegreeEducationTable = (props) => {
    const [columns] = useState([
        { name: "degree", title: translate("app.degreeEducation.table.name") },
      ]);
    ...
    const [defaultWidths, setDefaultWidths] = useState([
        { columnName: "degree", width: "auto" },
    
    ]);
    const [defaultHiddenColumnNames] = useState([]);
    const [sorting, getSorting] = useState([]);
    const [tableColumnExtensions] = useState([
        { columnName: "degree", wordWrapEnabled: true },
...
export default DegreeEducationTable
