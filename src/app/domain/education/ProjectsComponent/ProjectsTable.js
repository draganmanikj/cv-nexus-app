...
const ProjectsTable = (props) => {
  ...
  const [columns] = useState([
    {
      name: "institution",
      title: translate(`app.dosie.other.projectsForm.institution`),
    },
    {
      name: "name",
      title: translate(`app.dosie.other.projectsForm.name`),
    },
    {
      name: "role",
      title: translate(`app.dosie.other.projectsForm.role`),
    },
    {
      name: "dateStart",
      title: translate(`app.dosie.other.projectsForm.dateStart`),
    },
    {
      name: "dateEnd",
      title: translate(`app.dosie.other.projectsForm.dateEnd`),
    },
  ]);
  ...
  const [defaultWidths, setDefaultWidths] = useState([
    { columnName: "institution", width: "auto" },
