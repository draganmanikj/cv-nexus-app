...
const RolesPositionTypesTable = (props) => {
  const [columns] = useState([
    { name: "name", title: translate("app.rolesPositionTypes.table.name") },
    { name: "nameMk", title: translate("app.rolesPositionTypes.table.nameMK") },
...
export default RolesPositionTypesTable
