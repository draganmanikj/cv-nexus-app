...
const PrivateHealthcareTable = (props) => {
  const [columns] = useState([
    {
      name: "company",
      title: translate(`app.dosie.privateHealthcare.company`),
    },
    {
      name: "dateFrom",
      title: translate(`app.dosie.privateHealthcare.datumOd`),
    },
    {
      name: "dateTo",
      title: translate(`app.dosie.privateHealthcare.datumDo`),
    },
    {
      name: "status",
      title: translate("app.dosie.privateHealthcare.status"),
    },
  ]);
...
export default PrivateHealthcareTable;
