...
const WorkingPositionTypesTable = (props) => {
    const [columns] = useState([
        { name: "name", title: translate("app.workingPositionTypes.table.name") },
        { name: "nameMk", title: translate("app.workingPositionTypes.table.nameMk") },
    ...
    const [tableColumnExtensions] = useState([
        ...
        { columnName: "nameMk", wordWrapEnabled: true },
...
export default WorkingPositionTypesTable;
