...
const UniversityTableComponent = (props) => {
  const [columns] = useState([
    { name: "university", title: translate("app.university.table.name") },
  ]);
...
const [defaultWidths, setDefaultWidths] = useState([
    { columnName: "university", width: "auto" },
...
export default UniversityTableComponent