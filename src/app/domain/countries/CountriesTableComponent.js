...
const CountriesTableComponent = (props) => {
  const [columns] = useState([
    { name: "ime", title: translate("app.country.table.name") },
    { name: "drzavjanstvoMk", title: translate("app.country.table.citizenship") },
    { name: "kod2", title: translate("app.country.table.code") },
...
const [defaultWidths, setDefaultWidths] = useState([
    { columnName: "ime", width: "auto" },
    { columnName: "drzavjanstvoMk", width: "auto" },
    { columnName: "kod2", width: "auto" },
]);
const [defaultHiddenColumnNames] = useState([]);
const [sorting, getSorting] = useState([]);
const [tableColumnExtensions] = useState([
    { columnName: "ime", wordWrapEnabled: true },
    { columnName: "drzavjanstvoMk", wordWrapEnabled: true },
    { columnName: "kod2", wordWrapEnabled: true },
]);
