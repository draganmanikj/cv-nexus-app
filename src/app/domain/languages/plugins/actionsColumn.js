                                ...
                                >
                                    {actions.map((action) => {
                                        ...
                                        if (params.tableRow.row) {
                                            ...
                                            if (row.status && (action.name === "DEACTIVATE" || action.name === "EDIT"))
                                            {
                                                return (
                                        ...
                                        // if (!params.tableRow.row && action.name === "ADD") {
                                        //   return (
                                        //     <Tooltip placement="top" title={action.tooltip}>
                                        ...
                                        //       </Button> */}
                                        //     </Tooltip>
                                        //     // <Button variant="contained" key={"add"} color='primary' onClick={() => action.action()}>
                                        //     //     {action.icon}
                                        //     // </Button>
                                        //   );
                                        // }
